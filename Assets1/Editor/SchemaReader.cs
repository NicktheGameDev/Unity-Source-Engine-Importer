...
namespace TF2Ls
{
    public class SchemaReader : BaseTFToolsEditor<SchemaReader>
    {
        ...
        string SCHEMA_PATH => Path.Combine(new string[] { BlackMesaLsSettings.Settings.TFInstallPath, "scripts", "items", "items_game.txt" });
        string EN_LOCALE_PATH => Path.Combine(new string[] { BlackMesaLsSettings.Settings.TFInstallPath, "resource", "tf_english.txt" });
