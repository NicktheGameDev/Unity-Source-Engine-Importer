...
namespace TF2Ls.FaceFlex
{
    ...
    public class FaceFlexToolEditor : Editor
    {
        ...
        static string PresetPath => Path.Combine(BlackMesaLsSettings.Settings.PackagePath, "Face Flex Tool", "Presets");
        ...
        void Update()
        {
            ...
            if (AnimationMode.InAnimationMode())
            {
                if (animBackup == null)
                {
                    ...
                    {
                        if (BlackMesaLsSettings.Settings.EnableFlexesWhenAnimating)
                        {
