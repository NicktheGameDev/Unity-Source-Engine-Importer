    ...
    public class ModelTexturerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            EditorGUILayout.LabelField(
                ...
                , BlackMesaLsSettings.Settings.HelpTextStyle);
    ...
    public class ModelTexturerWindow : TFToolsSerializedEditorWindow<ModelTexturerData, ModelTexturerWindow>
    {
        ...
        private void OnGUI()
        {
            ...
            if ((SerializedObject == null || ModelTexturerData == null) && Event.current.type == EventType.Repaint)
            {
                ...
                if (showHelpText.boolValue) EditorGUILayout.LabelField("Add a MeshRenderer/SkinnedMeshRenderer to apply textures to just that mesh", BlackMesaLsSettings.Settings.HelpTextStyle);
                ...
                if (showHelpText.boolValue) EditorGUILayout.LabelField("Add a GameObject to apply textures to all Renderers in that GameObject and it's children", BlackMesaLsSettings.Settings.HelpTextStyle);
        ...
        void RenderHLExtractTools()
        {
            ...
            if (modelType.enumValueIndex == 1 || modelType.enumValueIndex == 2)
            {
                if (showHelpText.boolValue) EditorGUILayout.LabelField("Sorry, weapon and cosmetic importing is " +
                    "currently not ready to use.", BlackMesaLsSettings.Settings.HelpTextStyle);
                return;
            }
            ...
            if (showHelpText.boolValue) EditorGUILayout.LabelField("Choose folders for your model's " +
                ...
                "characters/weapons/cosmetics and to share folders for maps.", BlackMesaLsSettings.Settings.HelpTextStyle);
            ...
            if (showHelpText.boolValue) EditorGUILayout.LabelField("Tip: If your model comes out strangely black, try adjusting the material offsets!", BlackMesaLsSettings.Settings.HelpTextStyle);
        ...
        void ExtractVMTsFromMeshes()
        {
            ...
            string hlExtractPath = BlackMesaLsSettings.Settings.HLExtractPath;

            string packagePath = Path.Combine(BlackMesaLsSettings.Settings.TFInstallPath, VMT_VPK_FILENAME);
        ...
        void ExtractVTFsFromVMTs()
        {
            ...
            string hlExtractPath = BlackMesaLsSettings.Settings.HLExtractPath;
            string packagePath = Path.Combine(BlackMesaLsSettings.Settings.TFInstallPath, VTF_VPK_FILENAME);
        ...
        void ConvertVTFsToTextures()
        {
            ...
            {
                string vtfCmdPath = BlackMesaLsSettings.Settings.VTFCmdPath;
                int i = 0;
                while (i < vtfs.Count)
                {
